...
class Expense extends Model
{
    ...
    public static array $typeConfig = [
        'shopping' => [
            ...
            'icon'       => '<span class="material-symbols-outlined text-[24px]">shopping_bag</span>',
        ],
        'snacks' => [
            'label'      => 'Jajan',
            'bg'         => 'bg-orange-100',
            ...
            'icon'       => '<span class="material-symbols-outlined text-[24px]">fastfood</span>',
        ],
        'personal needs' => [
            ...
            'icon'       => '<span class="material-symbols-outlined text-[24px]">person</span>',
        ],
        'transportation' => [
            'label'      => 'Transportasi',
            'bg'         => 'bg-sky-100',
            ...
            'icon'       => '<span class="material-symbols-outlined text-[24px]">directions_car</span>',
        ],
        'savings' => [
            'label'      => 'Tabungan',
            'bg'         => 'bg-emerald-100',
        ...
        'bills' => [
            ...
            'icon'       => '<span class="material-symbols-outlined text-[24px]">receipt_long</span>',
        ],
        'other' => [
            'label'      => 'Lainnya',
            'bg'         => 'bg-slate-100',
