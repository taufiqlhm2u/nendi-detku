...
<head>
    ...
    <meta name="description"
        content="{{ $seo['description'] ?? 'Nendi Detku — aplikasi pencatat keuangan pribadi. Catat pemasukan, pengeluaran, dan pantau saldo kamu dengan mudah dan cepat.' }}">
    <meta name="keywords"
        content="{{ $seo['keywords'] ?? 'catat keuangan, money tracker, aplikasi keuangan pribadi, catat pemasukan pengeluaran, nendi detku' }}">
    ...
    <meta property="og:description"
        content="{{ $seo['description'] ?? 'Catat pemasukan, pengeluaran, dan pantau saldo kamu dengan mudah dan cepat.' }}">
